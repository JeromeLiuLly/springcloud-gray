...
public class OrderController {
	...
	public OrderInfo getOrderInfo(@RequestParam("userName") String userName) {
		...
		String metadata = ", user-service2  描述信息：";
		...
		if (map != null && !map.isEmpty() ) {
			metadata += "user-service2 metadata不为空,我是灰度服务!!! 服务metaData："+JSONObject.toJSONString(map) + "; ";
		}else{
			metadata += "user-service2 服务metaData是空,可以识别为正常服务; ";
		}
