...
public class UserController {
	...
	public String hello(@RequestParam("userName") String userName) {
		...
		String metadata = ", order-service 描述信息：";
		...
		if (map != null && !map.isEmpty() ) {
			metadata += "order-service metadata不为空,我是灰度服务!!! 服务metaData："+JSONObject.toJSONString(map) + "; ";
		}else{
			metadata += "order-service 服务metaData是空,可以识别为正常服务; ";
		}
